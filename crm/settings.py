...
SECRET_KEY = 'django-insecure-xm_89w+vtymv$57p2fb6j07183n5zva8fq+#xns!a7v%g5ch%8'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['bookshop-rni8.onrender.com']
...
TEMPLATES = [
    {
        ...
        # 'DIRS':[],  # Leave this empty if templates are within app directories
        'DIRS': [os.path.join(BASE_DIR, 'accounts', 'templates')],  # Specify the templates directory
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
